        ...
        <div className="container mx-auto px-4 overflow-hidden">
          <div className="text-center max-w-2xl mx-auto mb-16 overflow-hidden">
            <h2 className="text-3xl font-bold mb-4 break-words overflow-hidden">
              {t('choose')} <span className="gradient-text">{t('loanType')}</span>
            </h2>
            ...
            {loanTypes.map((loan) => (
              ...
              >
                <div className="flex items-start gap-4 mb-6 min-w-0">
                  <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${loan.color} flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0`}>
